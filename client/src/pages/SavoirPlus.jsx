...
const helpCategories = [
  {
    id: "getting-started",
    title: "Premiers pas",
    description: "Découvrez les bases de CRP MEMO",
    icon: BookOpen,
    color: "bg-blue-500",
    articles: 12
  },
  {
    ...
    description: "Maîtrisez tous les aspects de la gestion de projets",
    icon: FileText,
    color: "bg-green-500",
    articles: 8
  },
  {
    id: "crm",
    title: "CRM & Clients",
    description: "Optimisez votre relation client",
    icon: Users,
    color: "bg-purple-500",
    articles: 15
  },
...
const quickActions = [
  { title: "Contacter le support", icon: HelpCircle, action: "support" },
  { title: "Tutoriels vidéo", icon: Video, action: "videos" },
  { title: "Documentation API", icon: FileText, action: "api" },
  { title: "Communauté", icon: Users, action: "community" }
];
...
export default function SavoirPlus() {
  ...
  const categories = ["all", ...Array.from(new Set(featuredArticles.map(article => article.category)))];
