    ...
    <div className="h-screen w-full overflow-y-auto transition-colors duration-300 bg-gray-50 text-gray-900">
      <div className="p-6 md:p-8 lg:p-10">
        <motion.div
          ...
          className="p-6 rounded-2xl shadow-lg mb-8 bg-white border-gray-200 border"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          {[
            ...
            <motion.div
              ...
              className="p-6 rounded-xl shadow-md bg-white border-gray-200 border"
            >
        ...
        <motion.div
          ...
          className="p-6 rounded-2xl shadow-lg bg-white border-gray-200 border"
        >
          ...
          <div className="space-y-4">
            {[
              ...
              <div 
                key={index}
                className="p-4 rounded-lg border bg-gray-50 border-gray-200 hover:bg-gray-100 transition-colors duration-200"
              >
