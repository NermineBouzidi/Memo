...
import pmeImage from '../../assets/PMEdeservices.png';

export default function PMEServices() {
  ...
  return (
    <section className="py-24 px-4 md:px-12 bg-[#f9fafb]">
      <div className="max-w-5xl mx-auto text-center mb-16">
        ...
        >
          {t("pme.title").replace("MEMO", "").trim()} <span className="text-[#ef5d81]">MEMO</span>
        </motion.h1>
        <motion.p
          ...
          <div ref={cardRef} className="bg-white rounded-2xl shadow-sm px-8 py-10 hover:shadow-lg transition-all duration-300">
            ...
            <div className="mb-10">
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-gray-800 tracking-tight">{t("pme.challenge.title")}</h3>
              </motion.div>
            ...
            <div>
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-gray-800 tracking-tight">{t("pme.solution.title")}</h3>
              </motion.div>
